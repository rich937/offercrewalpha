...
- Home Equity / HELOC offers: Using your home as collateral is a significant call out, but it is not necessarily bad — it's a good way to get access to lower rates and higher lines. Home backed offers also require you to have a certain amount of equity in your home, which they can estimate at the time of the mailing, but they will have to verify in the application process. If a lender emphasizes “all online” then that typically means they use AVM’s instead of in-person appraisals.
- "Pre-approved" language means that the lender picked you for this offer because you meet their criteria. There will typically be another credit check if you take the offer, called a “hard pull”.
- Many offers use “as low as” language when they talk about APR’s. What that means is that the low rate is their “headline” rate — and the most qualified applicants can expect to get it.
- The Opt-Out disclosure box on a letter is a dead giveaway that it is a “pre-approved” offer.

Subprime Offers:
- Some offers are “subprime” — targeted to folks with lower credit scores. There is no stigma to subprime offers, but you should recognize them for what they are.
- It is not always easy to tell from a mail piece that it is subprime. They usually don’t discuss rate openly.
- Clue: If the loan/line amount is below $5,000 it is definitely subprime. If it is under $10,000, it might be.
